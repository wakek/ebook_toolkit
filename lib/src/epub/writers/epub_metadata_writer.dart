...
class EpubMetadataWriter {
  ...
  void writeMetadata(
    ...
    builder.element(
      ...
      nest: () {
        meta.titles?.forEach(
          (item) => builder.element('title', nest: item, namespace: dcNamespace),
        );
        meta.creators?.forEach(
        ...
        meta.types?.forEach(
          (type) => builder.element('type', namespace: dcNamespace, nest: type),
        );
        meta.formats?.forEach(
        ...
        meta.sources?.forEach(
          (item) => builder.element('source', namespace: dcNamespace, nest: item),
        );
        meta.languages?.forEach(
          (item) => builder.element(
            'language',
            namespace: dcNamespace,
            nest: item,
        ...
        meta.rights?.forEach(
          (item) => builder.element('rights', namespace: dcNamespace, nest: item),
        );
